...
with open(gpu_config_file) as json_data:
    gpu_config = json.load(json_data)

root_folder = gpu_config["root_folder"] + "/"
STATE_DIMENSIONS = gpu_config["state_dimensions"]

train_parameters = root_folder + "train_params.json"

actor_file = root_folder + gpu_config["actor_model"]
critic_file = root_folder + gpu_config["critic_model"]

actor_target_file = root_folder + gpu_config["actor_target_model"]
critic_target_file = root_folder + gpu_config["critic_target_model"]

new_data_folder = root_folder + gpu_config["new_data_folder"]
data_file = root_folder + gpu_config["data_file"]
