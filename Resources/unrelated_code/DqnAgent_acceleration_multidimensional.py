...
from Resources.unrelated_code.realEnvironment_acceleration_multidimensional import *
from Resources.unrelated_code.realEnvironment_acceleration_multidimensional import RealEnvironment as World
...
class DeepQNetworkAgent(object):
    ...
    train_parameters = "../../Resources/train_parameters_acceleration_multidimensional.json"
    ...
    def __init__(self):
        ...
        self.world = World(config["environment"], self.interface.set_status, self.interface.update_velocity)

        self.model = Factory.model_acceleration_q_multidim(self.world.STATE_DIMENSIONS, self.world.VELOCITY_DIMENSIONS, self.world.ACTIONS)
